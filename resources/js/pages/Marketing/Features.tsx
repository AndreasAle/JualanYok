    ...
    return (
        <div className="relative mx-auto min-h-[390px] max-w-xl">
            <div className="absolute inset-x-0 top-5 rounded-[1.6rem] border border-white/80 bg-white/85 p-4 shadow-[0_28px_70px_rgba(66,39,119,.18)] backdrop-blur-xl">
                <div className="flex items-center justify-between"><div><p className="text-[9px] font-bold text-neutral-400">JualanYok workspace</p><p className="mt-1 text-sm font-extrabold text-neutral-900">Semua alur, satu dashboard.</p></div><img src="/favicon.svg" alt="" className="size-9" /></div>
