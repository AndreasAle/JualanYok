...
import {
    ArrowLeft, CalendarDays, CheckCircle2, Clock, ImageIcon, MapPin, PlayCircle, ShieldCheck,
    ShoppingBag, Star, Truck, Users,
} from 'lucide-react';
                    ...
                    <aside className="lg:sticky lg:top-6">
                        <div className={cn(theme.card, 'p-5 sm:p-6')}>
                            ...
                            <button
                                type="button"
                                onClick={buy}
                                disabled={!product.external_url && !product.is_buyable}
                            ...
                            <ul className={cn('mt-5 space-y-2.5 text-xs', theme.muted)}>
                                <li className="flex items-center gap-2">
                                    ...
                                    Pembayaran aman lewat JualanYok
                                </li>
                                <li className="flex items-center gap-2">
                                ...
                                <li className="flex items-center gap-2">
                                    ...
                                    Bisa ajukan refund sesuai kebijakan
                                </li>
                            </ul>
                        </div>
            ...
            >
                <div className="mx-auto flex max-w-6xl items-center gap-3">
                    ...
                    >
                        ...
                        {product.external_url ? 'Lihat' : product.is_buyable ? 'Beli' : 'Habis'}
                    </button>
                </div>
            </div>
